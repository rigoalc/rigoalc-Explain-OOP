...
# Instance is an object included in a class. Every time that object variates is an instance of its class. 
...
# In the code example above, we can see the instance my_house_instance
...
#Include total time spent working on the assignment:

# The total time spent to complete the assignment was 20 hs 



# Answer the following question (yes or no): "Can I show your work for this assignment to other students? (this and future classes)"
# If so, do you want your name removed? (yes or no)

# You can show my work for this assignment to other students on this and in future classes. And is no necessary to remove my name.
